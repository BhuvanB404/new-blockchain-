...
import { Search, X, Leaf, Shield, FlaskConical, MapPin, Calendar, Thermometer, Droplets, CheckCircle, Plus } from 'lucide-react'
  ...
  const handleSearch = async (e) => {
    ...
    try {
      ...
      if (response.data.success) {
        ...
        toast.success('Batch details loaded! You can now add quality test results.')
      } else {
          ...
          <div className="p-6">
                    ...
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-purple-700">
                          Review the farmer details above and add quality test results for this batch.
                        </p>
                      </div>
                      <button
            ...
            {showQualityTestForm && (
              <QualityTestForm 
                ...
                onSubmit={handleQualityTestSubmit}
                batchId={batchId}
              />
            )}
          </div>
